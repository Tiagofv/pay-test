...
- Crie um repositório no seu GitHub **sem citar nada relacionado ao Empresa pay**. :heavy_check_mark:	
- Faça seus commits no seu repositório. :heavy_check_mark:	
- Envie o link do seu repositório para o email **talentos_php@empresapay.com**. (To-Do)	
- Você poderá consultar o Google, Stackoverflow ou algum projeto particular na sua máquina. :heavy_check_mark:	
- Dê uma olhada nos [Materiais úteis](#materiais-úteis). :heavy_check_mark:	
- Dê uma olhada em como será a [entrevista](#para-o-dia-da-entrevista-técnica). :heavy_check_mark:	
- Fique à vontade para perguntar qualquer dúvida aos recrutadores. :heavy_check_mark:	
- Fique tranquilo, respire, assim como você, também já passamos por essa etapa. Boa sorte! :) :heavy_check_mark:	
